                        ...
                        <div className="title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            <Link href="/">
                                <a className="flex items-center w-max">
                                    <img src="/logo.png" className="w-24 h-24 p-1" alt="logo-alt" />
                                    <span className="ml-0 text-xl lg:text-4xl font-algerian text-primary-one hover:text-secondary-three">Lotus Traders</span>
                                </a>
                            </Link>
                        </div>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 text-center lg:text-left w-full px-4">
                        ...
                        <div className="flex flex-col mb-2 lg:flex-row">
                            ...
                            <a href="tel:+91999999999" aria-label="Our phone" title="Our phone"
                                className="transition-colors duration-300 text-gray-900 hover:text-secondary-one">
                                (+91) 999999999
                            </a>
                        </div>
                        <div className="flex flex-col mb-2 lg:flex-row">
                        ...
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Our address"
                                title="Our address" className="transition-colors duration-300 text-gray-900 hover:text-secondary-one">
                ...
                <div className="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
                    <Link href="/">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            <img src="/logo.png" className="w-10 h-10 p-1" alt="logo-alt" />
                            {/* <span className="ml-3 text-xl">Lotus Traders</span> */}
                        </a>
                    </Link>
                    <p className="text-sm text-gray-500 sm:mt-0 mt-4">Lotus Traders © 2021 —
                        <a href="https://bezzietech.com" rel="noopener noreferrer" className="text-gray-600 ml-1 text-primary-one hover:text-secondary-one" target="_blank">BezzieTech</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a className="text-tertiary duration-300 hover:cursor-pointer hover:transform hover:scale-105 hover:text-primary-three">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a className="ml-3 text-tertiary duration-300 hover:cursor-pointer hover:transform hover:scale-105 hover:text-primary-three">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
